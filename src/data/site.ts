...
export const teams = [
  {
    ...
    icon: 'code',
    image: '/images/teams/programming.png',
  ...
  },
  {
    ...
    icon: 'pen',
    image: '/images/teams/illustration.png',
